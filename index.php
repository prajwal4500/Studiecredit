...
:root{--bg:#ffffff;--bg2:#f7f7f5;--ink:#0a0a0a;--ink2:#1a1a1a;--ink3:#444;--muted:#888;--border:#e0ddd8;}
...
nav{display:flex;justify-content:space-between;align-items:center;padding:20px 56px;background:rgba(255,255,255,.96);border-bottom:1px solid var(--border);position:sticky;top:0;z-index:10;backdrop-filter:blur(8px)}
...
.nav-tag{font-family:'DM Mono',monospace;font-size:.6rem;letter-spacing:.15em;text-transform:uppercase;color:var(--muted);border:1px solid var(--border);padding:5px 12px;border-radius:2px}
.hero{text-align:center;padding:110px 24px 80px;max-width:800px;margin:0 auto;position:relative;z-index:1}
.eyebrow{font-family:'DM Mono',monospace;font-size:.6rem;letter-spacing:.28em;text-transform:uppercase;color:var(--muted);display:inline-flex;align-items:center;gap:10px;margin-bottom:32px}
.eyebrow::before,.eyebrow::after{content:'';display:block;width:32px;height:1px;background:var(--border)}
.hero h1{font-family:'Playfair Display',serif;font-weight:900;font-size:clamp(2.6rem,7vw,4.8rem);line-height:1.02;margin-bottom:24px;color:var(--ink);letter-spacing:-.03em}
...
.btn-primary{display:inline-flex;align-items:center;gap:10px;background:var(--ink);color:#fff;font-family:'DM Sans',sans-serif;font-weight:600;font-size:.88rem;padding:15px 36px;border-radius:2px;text-decoration:none;letter-spacing:.03em;transition:opacity .2s,transform .15s}
...
.features{display:grid;grid-template-columns:repeat(3,1fr);max-width:900px;margin:0 auto 60px;border:1px solid var(--border);border-radius:2px;position:relative;z-index:1}
...
.cta-strip{background:var(--ink);border-radius:2px;padding:48px 52px;display:flex;justify-content:space-between;align-items:center;gap:24px;max-width:852px;margin:0 auto 60px;position:relative;z-index:1}
...
.btn-inv{display:inline-flex;align-items:center;gap:8px;background:#fff;color:var(--ink);font-family:'DM Sans',sans-serif;font-weight:600;font-size:.86rem;padding:14px 32px;border-radius:2px;text-decoration:none;white-space:nowrap;transition:opacity .2s}
.btn-inv:hover{opacity:.88}
footer{text-align:center;padding:28px;font-family:'DM Mono',monospace;font-size:.52rem;color:var(--border);letter-spacing:.2em;text-transform:uppercase;border-top:1px solid var(--border);position:relative;z-index:1}
</style>
</head>
<body>
<nav>
...
<div class="hero">
  ...
  <p class="hero-sub">Design your own credit scoring engine. Set the rules, assign weightages, let the public apply — your PHP backend scores them in real time.</p>
...
<div class="features">
  <div class="feat">
    ...
    <div class="feat-desc">Assign importance to Income, DSCR, Debt Load, Employment and Repayment history. Your weights define your model. Total must equal 100.</div>
  </div>
  <div class="feat">
    <span class="feat-num">02</span>
    <span class="feat-icon">🧮</span>
    <div class="feat-title">PHP Scores in Backend</div>
    <div class="feat-desc">No JavaScript scoring. The engine runs in PHP — applicants submit a form, the server calculates DSCR and applies your weightages, then returns the verdict.</div>
  </div>
  <div class="feat">
    <span class="feat-num">03</span>
    <span class="feat-icon">📊</span>
    <div class="feat-title">Real Financial Inputs</div>
    <div class="feat-desc">Income, expenses, existing EMIs, loan requested, employment years, loans taken and repayments made. Real data → real score → real decision.</div>
  </div>
</div>
...
<footer>Credit Score Engine &nbsp;·&nbsp; Student FinTech Project &nbsp;·&nbsp; Built with PHP</footer>
</body>
</html>
